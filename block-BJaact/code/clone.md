...
console.log(person2.firstName); // Arya  Copied by reference
console.log(person.firstName); // Arya Copied By Reference
console.log(person.lastName); // Doe 
console.log(person == person2); // true same reference
console.log(person === person2); // true same reference address
...
console.log(personTwo.firstName); // John refernce address for personTWo is different than that of person because of cloning so change in person's data will not be applied on personTwo.
...
console.log(person === personTwo); // false
console.log(person.address === personTwo.address); // true same reference address
